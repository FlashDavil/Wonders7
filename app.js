...
resultElement1.style.color='white'
resultElement2.style.color='white'
resultElement3.style.color='white'
resultElement4.style.color='white'
resultElement5.style.color='white'
resultElement6.style.color='white'
}
 
/* const arr = [resultElement1.textContent, resultElement2.textContent, resultElement3.textContent, resultElement4.textContent,resultElement5.textContent,resultElement6.textContent]
